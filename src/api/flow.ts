 ...
 */
export const getFlowList = (params?: GetFlowListParams, options?: SecondParameter<typeof customInstance>) => {
  return customInstance<FlowListItemData[]>({ url: `/flow`, method: "GET", params }, options)
}
